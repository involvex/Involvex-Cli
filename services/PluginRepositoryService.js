...
class PluginRepositoryService {
    constructor(logService) {
        ...
        this.repositoryUrl = 'https://raw.githubusercontent.com/involvex/Involvex-Cli/main/plugins-repository.json';
        this.localRepositoryPath = path.join(os.homedir(), 'AppData', 'Roaming', 'InvolveX', 'plugins-repository.json');
    }
